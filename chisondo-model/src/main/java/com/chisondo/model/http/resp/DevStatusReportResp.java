 ...
 * 设备状态上报请求
 */
public class DevStatusReportResp extends CommonHttpResp {
    /**
     * 固定值: statuspush
     * 表示上报设备状态
     */
    ...
    public DevStatusMsgResp getMsg() {
        return msg;
    }

    public void setMsg(DevStatusMsgResp msg) {
        this.msg = msg;
    }
